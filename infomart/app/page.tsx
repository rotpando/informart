...
export default function Home() {
  ...
  return (
    <main className="m-8 md:m-20 text-justify">
        ...
        <ul>
          ...
          <ul>
            ...
            <li className="text-justify">{lang === 'es' ? 'A través del análisis crítico y riguroso, buscamos identificar y denunciar las injusticias laborales. Promovemos la organización y la movilización de lxs trabajadorxs para defender sus derechos. Buscamos la aplicación efectiva de los mismos y conquistar mejoras en sus condiciones laborales' : 'Through critical and rigorous analysis, we aim to identify and denounce labor injustices. We advocate for the organization and mobilization of workers to defend their rights. We strive for the effective implementation of these rights and the achievement of improvements in their working conditions.'}</li>
        </ul>
          
    
    
          <h2>{lang === 'es' ? 'Visión' : 'Vision'}</h2>
        <ol>
            <li className="text-justify">{lang === 'es' ? 'Buscamos una sociedad en la que los medios de producción estén en manos de la clase trabajadora, se hayan abolido las desigualdades sociales y se haya instaurado una democracia genuina en todos los aspectos de la vida, incluido el ámbito laboral. Trabajamos para fortalecer la conciencia de clase entre lxs trabajadorxs y para que sean protagonistas de su propia liberación.' : 'We seek a society where the means of production are in the hands of the working class, where social inequalities have been abolished, and where genuine democracy is established in all aspects of life, including the realm of labor. We work to strengthen class consciousness among workers and empower them to be the protagonists of their own liberation.'}</li>
        </ol>
